...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicCentimeterPerMinute, q => q.ToUnit(StandardFlowUnit.StandardCubicCentimeterPerMinute));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicCentimeterPerMinute, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicCentimeterPerSecond, q => q.ToUnit(StandardFlowUnit.StandardCubicCentimeterPerSecond));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicCentimeterPerSecond, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicDecimeterPerMinute, q => q.ToUnit(StandardFlowUnit.StandardCubicDecimeterPerMinute));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicDecimeterPerMinute, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicFootPerDay, q => q.ToUnit(StandardFlowUnit.StandardCubicFootPerDay));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicFootPerDay, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicFootPerHour, q => q.ToUnit(StandardFlowUnit.StandardCubicFootPerHour));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicFootPerHour, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicFootPerMinute, q => q.ToUnit(StandardFlowUnit.StandardCubicFootPerMinute));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicFootPerMinute, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicFootPerSecond, q => q.ToUnit(StandardFlowUnit.StandardCubicFootPerSecond));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicFootPerSecond, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicMeterPerDay, q => q.ToUnit(StandardFlowUnit.StandardCubicMeterPerDay));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicMeterPerDay, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicMeterPerHour, q => q.ToUnit(StandardFlowUnit.StandardCubicMeterPerHour));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicMeterPerHour, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicMeterPerMinute, q => q.ToUnit(StandardFlowUnit.StandardCubicMeterPerMinute));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicMeterPerMinute, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlow.BaseUnit, q => q);
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicMillimeterPerSecond, q => q.ToUnit(StandardFlowUnit.StandardCubicMillimeterPerSecond));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicMillimeterPerSecond, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicYardPerDay, q => q.ToUnit(StandardFlowUnit.StandardCubicYardPerDay));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicYardPerDay, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicYardPerHour, q => q.ToUnit(StandardFlowUnit.StandardCubicYardPerHour));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicYardPerHour, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicYardPerMinute, q => q.ToUnit(StandardFlowUnit.StandardCubicYardPerMinute));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicYardPerMinute, StandardFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlow.BaseUnit, StandardFlowUnit.StandardCubicYardPerSecond, q => q.ToUnit(StandardFlowUnit.StandardCubicYardPerSecond));
            unitConverter.SetConversionFunction<StandardFlow>(StandardFlowUnit.StandardCubicYardPerSecond, StandardFlow.BaseUnit, q => q.ToBaseUnit());
