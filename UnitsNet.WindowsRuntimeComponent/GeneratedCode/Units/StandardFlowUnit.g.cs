...
namespace UnitsNet.Units
{
    ...
    public enum StandardFlowUnit
    {
        Undefined = 0,
        StandardCubicCentimeterPerMinute,
        StandardCubicCentimeterPerSecond,
        StandardCubicDecimeterPerMinute,
        StandardCubicFootPerDay,
        ...
        StandardCubicYardPerDay,
        StandardCubicYardPerHour,
        StandardCubicYardPerMinute,
        StandardCubicYardPerSecond,
    }
