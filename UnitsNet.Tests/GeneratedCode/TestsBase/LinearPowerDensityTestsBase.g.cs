...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var positiveInfinityQuantity = new LinearPowerDensity(double.PositiveInfinity, LinearPowerDensityUnit.WattPerMeter);
            var negativeInfinityQuantity = new LinearPowerDensity(double.NegativeInfinity, LinearPowerDensityUnit.WattPerMeter);
        ...
        {
            var nanQuantity = new LinearPowerDensity(double.NaN, LinearPowerDensityUnit.WattPerMeter);
...
#pragma warning restore 618
        ...
        [Fact]
        public void FromWattsPerMeter_WithInfinityValue_CreateQuantityAndAffectInfinityValue()
        {
            var positiveInfinityQuantity = LinearPowerDensity.FromWattsPerMeter(double.PositiveInfinity);
            var negativeInfinityQuantity = LinearPowerDensity.FromWattsPerMeter(double.NegativeInfinity);
        ...
        [Fact]
        public void FromWattsPerMeter_WithNanValue_CreateQuantityAndAffectNaNValue()
        {
            var nanQuantity = LinearPowerDensity.FromWattsPerMeter(double.NaN);
            Assert.True(double.IsNaN(nanQuantity.Value));
        }
