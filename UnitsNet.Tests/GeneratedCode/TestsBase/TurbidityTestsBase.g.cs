...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var positiveInfinityQuantity = new Turbidity(double.PositiveInfinity, TurbidityUnit.NTU);
            var negativeInfinityQuantity = new Turbidity(double.NegativeInfinity, TurbidityUnit.NTU);
        ...
        {
            var nanQuantity = new Turbidity(double.NaN, TurbidityUnit.NTU);
...
#pragma warning restore 618
        ...
        [Fact]
        public void FromNTU_WithNanValue_CreateQuantityAndAffectNaNValue()
        {
            var nanQuantity = Turbidity.FromNTU(double.NaN);
            Assert.True(double.IsNaN(nanQuantity.Value));
        }
