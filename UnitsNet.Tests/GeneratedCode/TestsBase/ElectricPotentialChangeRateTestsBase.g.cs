...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var positiveInfinityQuantity = new ElectricPotentialChangeRate(double.PositiveInfinity, ElectricPotentialChangeRateUnit.VoltPerSecond);
            var negativeInfinityQuantity = new ElectricPotentialChangeRate(double.NegativeInfinity, ElectricPotentialChangeRateUnit.VoltPerSecond);
        ...
        {
            var nanQuantity = new ElectricPotentialChangeRate(double.NaN, ElectricPotentialChangeRateUnit.VoltPerSecond);
...
#pragma warning restore 618
        ...
        [Fact]
        public void FromVoltsPerSeconds_WithInfinityValue_CreateQuantityAndAffectInfinityValue()
        {
            var positiveInfinityQuantity = ElectricPotentialChangeRate.FromVoltsPerSeconds(double.PositiveInfinity);
            var negativeInfinityQuantity = ElectricPotentialChangeRate.FromVoltsPerSeconds(double.NegativeInfinity);
        ...
        [Fact]
        public void FromVoltsPerSeconds_WithNanValue_CreateQuantityAndAffectNaNValue()
        {
            var nanQuantity = ElectricPotentialChangeRate.FromVoltsPerSeconds(double.NaN);
            Assert.True(double.IsNaN(nanQuantity.Value));
        }
