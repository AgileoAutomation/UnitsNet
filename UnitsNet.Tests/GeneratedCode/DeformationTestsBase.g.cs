...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var positiveInfinityQuantity = new Deformation(double.PositiveInfinity, DeformationUnit.Microdeformation);
            var negativeInfinityQuantity = new Deformation(double.NegativeInfinity, DeformationUnit.Microdeformation);
        ...
        {
            var nanQuantity = new Deformation(double.NaN, DeformationUnit.Microdeformation);
        ...
        [Fact]
        public void FromMicrodeformations_WithInfinityValue_CreateQuantityAndAffectInfinityValue()
        {
            var positiveInfinityQuantity = Deformation.FromMicrodeformations(double.PositiveInfinity);
            var negativeInfinityQuantity = Deformation.FromMicrodeformations(double.NegativeInfinity);
        ...
        [Fact]
        public void FromMicrodeformations_WithNanValue_CreateQuantityAndAffectNaNValue()
        {
            var nanQuantity = Deformation.FromMicrodeformations(double.NaN);
            Assert.True(double.IsNaN(nanQuantity.Value));
        }
