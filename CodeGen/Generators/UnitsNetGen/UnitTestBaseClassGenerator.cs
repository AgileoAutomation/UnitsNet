...
");
        ...
        {{
            var positiveInfinityQuantity = new {_quantity.Name}(double.PositiveInfinity, {_baseUnitFullName});
            var negativeInfinityQuantity = new {_quantity.Name}(double.NegativeInfinity, {_baseUnitFullName});
        ...
        {{
            var nanQuantity = new {_quantity.Name}(double.NaN, {_baseUnitFullName});
